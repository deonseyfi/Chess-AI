...
public class Board extends JPanel implements MouseListener, MouseMotionListener {
    ...
    private int MinMax_CalcVal(boolean turnSelector) {
        ...
        int pUnderThreat = 0;
        int kingUnderThreat = 0, kingAttackThreat = 0;
        int queenUnderThreat  = 0, queenAttackThreat = 0;
        int rookUnderThreat = 0, rookAttackThreat = 0;
        int knightUnderThreat  = 0, knightAttackThreat = 0;
        int bishopUnderThreat = 0, bishopAttackThreat = 0;
        int pawnUnderThreat = 0, pawnAttackThreat = 0;
        ...
        for (i = 0; i < pCount; i++) {
            ...
            for (j = 0; j < possibleMoves.size(); j++) {
                ...
                if (occPiece != null)
                {
                    ...
                    if ((turnSelector) && (occPiece.getColor() == 0)) { // White Piece attacking Black Piece
                        pUnderThreat++;
                        if (occPiece.getClass().getName().equals("Queen")){
                            queenUnderThreat++;
                        }
                    }
                    if ((!turnSelector) && (occPiece.getColor() == 1)) { // Black Piece attacking White Piece
                    ...
                    if ((turnSelector) && (occPiece.getColor() == 0)) { // White Piece attacking Black Piece
                        pUnderThreat++;
                        if (occPiece.getClass().getName().equals("Rook")){
                            rookUnderThreat++;
                        }
                    }
                    if ((!turnSelector) && (occPiece.getColor() == 1)) { // Black Piece attacking White Piece
                    ...
                    if ((turnSelector) && (occPiece.getColor() == 0)) { // White Piece attacking Black Piece
                        pUnderThreat++;
                        if (occPiece.getClass().getName().equals("Knight")){
                            knightUnderThreat++;
                        }
                    }
                    if ((!turnSelector) && (occPiece.getColor() == 1)) { // Black Piece attacking White Piece
                    ...
                    if ((turnSelector) && (occPiece.getColor() == 0)) { // White Piece attacking Black Piece
                        pUnderThreat++;
                        if (occPiece.getClass().getName().equals("Bishop")){
                            bishopUnderThreat++;
                        }
                    }
                    if ((!turnSelector) && (occPiece.getColor() == 1)) { // Black Piece attacking White Piece
                    ...
                    if ((turnSelector) && (occPiece.getColor() == 0)) { // White Piece attacking Black Piece
                        pUnderThreat++;
                        if (occPiece.getClass().getName().equals("Pawn")){
                            pawnUnderThreat++;
                        }
                    }
                    if ((!turnSelector) && (occPiece.getColor() == 1)) { // Black Piece attacking White Piece
        ...
        if (pawnAttackThreat > 1)
            pawnAttackThreat = 1;

        if (pawnUnderThreat > 1)
            pawnUnderThreat = 1;
        System.out.println("");
        System.out.println("King under Threat: " + kingUnderThreat);
        System.out.println("King Attack Threat: " + kingAttackThreat);
        System.out.println("Queen under Threat: " + queenUnderThreat);
        System.out.println("Queen Attack Threat: " + queenAttackThreat);
        System.out.println("Rook under Threat: " + rookUnderThreat);
        System.out.println("Rook Attack Threat: " + rookAttackThreat);
        System.out.println("Knight under Threat: " + knightUnderThreat);
        System.out.println("Knight Attack Threat: " + knightAttackThreat);
        System.out.println("Bishop under Threat: " + bishopUnderThreat);
        System.out.println("Bishop Attack Threat: " + bishopAttackThreat);
        System.out.println("Pawn under Threat: " + pawnUnderThreat);
        System.out.println("Pawn Attack Threat: " + pawnAttackThreat);


        valMinMax = (pawnUnderThreat * -10) + (pawnAttackThreat * 10) + (bishopUnderThreat * -20) + (bishopAttackThreat * 20) +(knightUnderThreat* -30)
                +(knightAttackThreat * 30)+ (rookUnderThreat * -50) + (rookAttackThreat * 50) + (queenUnderThreat * -80) +
               (queenAttackThreat * 80) + (kingAttackThreat * 1000) + (kingUnderThreat * -1000);
    ...
    private Pair<Integer, Square> MinMax_SelectSquare(Piece chessPiece, boolean turnSelector, int depthLevel, String prevPos) {
